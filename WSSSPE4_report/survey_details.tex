...
\begin{figure}[!htb]
    ...
    \label{fig:SFig1}
    }{\includegraphics[width=.33\linewidth]{SurveyFig1rev}}
    ~
    \subcaptionbox{
    The balance was right between talks, panels, and lightning talks.
    \label{fig:SFig2}
    }{\includegraphics[width=.32\linewidth]{SurveyFig2rev}}
    ~
    \subcaptionbox{
    There was sufficient time for discussion.
    \label{fig:SFig3}
    }{\includegraphics[width=.26\linewidth]{SurveyFig3rev}}
...
\item \textbf{What part of the meeting was the most valuable? select all that apply}

\begin{figure}[h!]
    \centering
    \begin{tabular}{@{}c@{}}
        \includegraphics[width=0.35\textwidth]{SurveyFig4rev}
    \end{tabular}
    \qquad
...
\item \textbf{What additional topics would you like to see discussed at the next meeting?}
...
\item \textbf{What would make you more likely to invest time in future WSSSPE initiatives?}
...
\item \textbf{Would you be interested in joining a professional society focused around the topics of WSSSPE?}

\begin{figure}[h!]
    \centering
    \begin{tabular}{@{}c@{}}
        \includegraphics[width=0.35\textwidth]{SurveyFig5rev}
    \end{tabular}
    \qquad
    \rowcolors{1}{}{lightgray}
    \begin{tabular}{@{}lc@{}}
...
\item \textbf{Will you be part of a working group with colleagues going forward on a topic addressed at WSSSPE, and if so, which one?}

\begin{figure}[h!]
    \centering
    \begin{tabular}{@{}c@{}}
        \includegraphics[width=0.35\textwidth]{SurveyFig6rev}
    \end{tabular}
    \qquad
    \rowcolors{1}{}{lightgray}
    \begin{tabular}{@{}lc@{}}

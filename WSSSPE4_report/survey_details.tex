...
\begin{figure}[!htb]
    ...
    \label{fig:SFig1}
    }{\includegraphics[width=.34\linewidth]{figures/SurveyFig1rev}}
    ~
    \subcaptionbox{
    ...
    \label{fig:SFig3}
    }{\includegraphics[width=.25\linewidth]{figures/SurveyFig3rev}}
    \caption{Responses to generate questions about the conference program}
\end{figure}
...
\begin{figure}[h!]
    ...
    \hfill
    \killfloatstyle\capbtabbox[\linewidth]{%
...
\begin{figure}[h!]
    ...
    \ffigbox[\FBwidth]{%
        ...
        \captionsetup{width=\linewidth}
        \caption{Would you be interested in joining a professional society
        focused around the topics of WSSSPE?
        \label{fig:SFig5}}%
    }
    %\hfill
    ~
...
\begin{figure}[h!]
    ...
    \ffigbox[\FBwidth]{%
        ...
        \captionsetup{width=\linewidth}
        \caption{Will you be part of a working group  with colleagues going
        forward  on a topic addressed at WSSSPE?
        \label{fig:SFig6}}%
    }
    ~
    \killfloatstyle\capbtabbox[\linewidth]{%

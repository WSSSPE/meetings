...
%\todo{should remove these 3 figure borders in the figure source, then in LaTeX place them all in row of fix to use multifig}
\begin{figure}[h!]
...
%\todo{remove figure border}
\begin{figure}[h!]
\includegraphics{figures/SurveyFig4rev}
...
%\todo{remove figure border}
\begin{figure}[h]
\includegraphics{figures/SurveyFig5rev}
...
%\todo{remove figure border}
\begin{figure}[h]
\includegraphics{figures/SurveyFig6rev}

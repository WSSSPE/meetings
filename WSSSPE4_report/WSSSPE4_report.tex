...
discusses the participant, the objective and goal, and how the objective can
...
\begin{itemize}[itemsep=1ex]
    ...
    specifications, and software contracts to check (e.g.) \todo{Kyle, should something be here?}expected value ranges
    ...
    the development process with (e.g.) \todo{Kyle, again an e.g. with no example?} static code checkers and Git commit hooks,

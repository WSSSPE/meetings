...
\note{list of sections that is in the process of being confirmed} 

Sections: 

\begin{itemize}
\item Verifying best practices \& metrics for sustainable research software [Ray Idaszak]
\item \todo{to confirm} Software Sustainability Alliance [Neil \& Jean]
...
\item \todo{to confirm} Social Science of Scientific Software [Stuart Geiger]
\item Software Best Practices for Undergraduates [Jonah Miller]
\item Meaningful metrics for sustainable software [Emily Chen]
\item \todo{to confirm} Coordinating access to CI for research software [Mark Abraham]
\item Software engineering processes tailored for research software [Anshu Dubey]
\item Open research index [Dan]
\item \todo{to confirm} Letters of evaluation for computational scientists [Wolfgang Bangerth]
\end{itemize}

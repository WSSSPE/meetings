...
that WSSSPE is both a community in addition to a set of associated workshops.
...
Intro and description \katznote{not sure enum is right here}
%
\begin{enumerate}

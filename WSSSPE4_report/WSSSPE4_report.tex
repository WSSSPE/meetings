...
These events included discussion of the WSSSPE mission and vision, a keynote,
...
%
For talks with multiple authors, an \textsuperscript{\textasteriskcentered} indicates the author who presented the talk.
%
%\todo{group by type - idea, position, experience, demo}

The following four papers belong to the first area and tackle diverse aspects from incentives for quality software to advocating a professional society for research software to roles and degrees for research software engineers.
\begin{itemize}
...
Three contributions present work on the third main area and elucidate about lessons learned from or visions for use cases of scientific software and communities working with and\slash or on a software package.

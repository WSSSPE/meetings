...
\todo{need to mention/link to the proceedings here.}
...
\katznote{not sure enum list is right here}
\kylenote{I'm fine with itemize, but they were in a particular order, right?}
%
\begin{enumerate}
    ...
    Description
    %Didn’t want to “preach” to the community, wanted to be integrated with the
    % community, hence the fellows programme. Five attending WSSSPE this year.
    ...
    Description
    %Some people greatly encouraged to only submit to a journal code that has been peer reviewed

    \item \textbf{Frank Löffler and Steven Brandt\textsuperscript{\textasteriskcentered}:
    \emph{A vision of computing in 10+ years}}.
    Description
    %“We (need to) decouple science from numerical methods and optimization” Hard open problem.
    ...
    \emph{Software Citation: Process, Principles, and Implementation}}.
    Description
    ...
    Best Practices and Culture Change for Developing Sustainable Community Software}}.
    Description

    \item \textbf{Lorraine Hwang\textsuperscript{\textasteriskcentered},
    Wolfgang Bangerth, Timo Heister, and Louise Kellogg:
    \emph{ASPECT: Hackathons as an Example of Sustaining an Open Source Community}}.
    Description

    \item \textbf{Carole Goble: \emph{A Simple Profiling Framework for Software
    User-Producer Maturity Review}}.
    Description
    ...
    Andrei Chiș, Benoit Combemale, Mike Croucher, Kevin Crowston, Daniel Garijo,
    ...
    Ralf Lämmel, Oscar Nierstrasz, Matt Turk, Rob van Nieuwpoort, Matthew Vaughn,
    and Jurgen Vinju: \emph{``I solemnly pledge'': A Manifesto for Personal
    Responsibility in the Engineering of Academic Software}}.
    Description

...
\todo{go through subsections that have both content here and appendix, and add pointer from text in the subsection here to the corresponding appendix} \todo{though think about if an appendix is the right thing if we decide to publish in JORS again}
...
\note{need a person to write this - Dan asked Lorraine}
...
Foundation under grant ACI-1648293, by the Gordon and Betty Moore Foundation under gift \todo{check to see if there's a number}, and by the Alfred P.~Sloan Foundation

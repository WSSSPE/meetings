...
\begin{itemize}
\item The Research Computing Association has produced a ``Dear Colleague'' letter on the issue. \katznote{add citation}
\item The National Science Foundation has produced a ``Dear Colleague'' letter that defines a ``product'' for the purposes of 2-page biosketches that does not include only publications, but also software. \katznote{add citation or link?}
\item The ACM published an article in the CACM (one of the co-authors
  was David Patterson) \katznote{why is Patterson significant here?} that explained that conference proceedings are
...
\item There is also a 1995 report by the National Academies about
  ...
  theoretical research. \katznote{add citation -- \url{https://www.nap.edu/catalog/2236/academic-careers-for-experimental-computer-scientists-and-engineers}}
\end{itemize}

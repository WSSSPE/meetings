...
\begin{abstract}      
\todo{update abstract}
This technical report records and discusses the alternative submission and peer-review process used by
...
both the program-organization model adapted by WSSSPE2
as well as the papers accepted by the workshop.
\end{abstract}

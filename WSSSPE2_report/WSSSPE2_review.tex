...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Keynotes} \label{keynotes}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\todo{Lead: Choi. Volunteers welcome---contact lead}

\todo{Live notes at \url{http://tinyurl.com/q6ew45v}.
%https://docs.google.com/document/d/1-BxkYWDQ6nNNBXBStUL0xcKF9qCTlEALwf928J_MemI/edit?usp=sharing
Abstracts at \url{http://tinyurl.com/mnenzms}}
...
\href{http://tinyurl.com/mpbhvyb}{Google doc notes}
...
\href{http://tinyurl.com/pn4eq8z}{Google doc notes}
...
\href{http://tinyurl.com/k8ruyn9}{Google doc notes}
...
\href{http://tinyurl.com/kqpe87z}{Google doc notes}
...
\href{http://tinyurl.com/l5t5h45}{Google doc notes}

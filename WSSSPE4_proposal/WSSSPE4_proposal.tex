...
Reports describing the activities of WSSSPE and WSSSPE2 culminated in peer-reviewed articles~\cite{WSSSPE1,WSSSPE2}, while the report from WSSSPE3 is currently undergoing peer review (and is available via the arXiv)~\cite{WSSSPE3}; all reports are publicly available via publication in an open-access journal.

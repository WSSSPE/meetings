...
levels of turnover and inappropriate incentives are a significant contributing
factor to low levels of reliability and readability observed in scientific
...
engaged/invested in the research context are co-developing software with domain
academics.

\subsubsection{Fit with related activities}

The solution we envision entails creating an environment where software
developers are a stable part of the research team. Such an environment mitigates
...
senior developers is hard, because these people are highly in demand by the
...
party sought alternate solutions that may be achievable within the context of
...
not be measured by publications, we hope, but by other measures. Middle-author
...
research software engineering resources, as the need for, and funding for, these
activities is intermittent within the research cycle. To sustain this capacity,
...
stating ``I'm a research software engineer,'' has been important to the
...
investment to investigators within the university. This is an issue best
...
not identify themselves as such at this time. We will collect information as to
...
RSE track, whether they bear the the RSE moniker or not. Are these developers

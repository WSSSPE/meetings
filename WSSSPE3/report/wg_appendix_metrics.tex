...
The following summary of the group's discussion represents the Useful Metrics
...
\item
Coordination (mail communication, info page etc), via WSSSPE GitHub or? \choinote{incomplete sentence}

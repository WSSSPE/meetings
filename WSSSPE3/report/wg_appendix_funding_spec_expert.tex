...
\item Simon Trigger \choinote{TBD}
...
\choinote{Please review this short, fragmented paragraph.}
...
as resourcing this from the staff of the Edinburgh Parallel Computing Centre, \choinote{not sure what the previous part means}
...
then more funding could follow. \choinote{I find the last sentence unclear.} This could apply within or across institutions.

There can be communication problems across cultural barriers, with domain
...
\choinote{Last sentence have at least two verbs.}
...
There is some questions about the most effective duration and percent of full
...
cyberinfrastructure component is clear. \choinote{last sentence unclear} Funding which permits code to be
refactored, tidied and optimized is rare; this is often done ``on the sly'' \choinote{on the fly?} in a
...
sustaining following. \choinote{following what?}

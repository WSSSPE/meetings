...
Mozilla Science maintains a ``Working Open Project Guide'' (\url{http://mozillascience.github.io/leadership-training}). \katznote{should get changed to a cite} From the introduction:
\begin{quote}
...
\begin{itemize}
\item ``Art of Community'' by Jono Bacon. \katznote{cite?} We could consider distilling this for scientific software.
...
Additional details on the group's discussion can be found in Appendix~\ref{sec:appendix_user_community}.

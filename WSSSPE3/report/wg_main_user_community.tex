...
Mozilla Science maintains a ``Working Open Project Guide'' (\url{http://mozillascience.github.io/leadership-training}), the introduction of which states: \katznote{should get changed to a cite}
\begin{quote}

...
\item KBase: narratives built on IPython\slash Jupyter notebooks; to build
...
which might provide advantages:
\begin{itemize}
...
combined into a single content item. \choinote{What's RIO?}
...
similar for publications about software by making a public page \choinote{where?} containing a

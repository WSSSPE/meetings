...
One important use of this system is to track rights and credits for contributors
...
%the software itself) \choinote{DOI is in the list below}
includes:
\begin{itemize}
...
to align with our group discussions. Taylor also mentioned another benefit of the
...
DOIs, but the identifiers are still not widely adopted. Also, there is no mechanism to cite

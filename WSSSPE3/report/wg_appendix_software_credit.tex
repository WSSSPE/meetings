...
\end{itemize}
\katznote{is a name/title also needed?}
...
DataCite DOIs.
Therefore, even with universal association of scientific software with DOIs 
and standardizing practices for citing software in publications \katznote{this sentence is missing its ed}
...
are typically not tenured and thus may not be influential enough. \katznote{to do what?}

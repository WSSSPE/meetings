%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Software Credit Working Group Discussion}
...
\item Transitive credit~\cite{Katz:2014_tc,katz-smith-tc}, which assigns
...
\noindent Software Citation Metadata:
...
JSON-LD~\cite{katz-smith-tc}. Some questions arose about how this information
...
\noindent Citing Software in Publications:

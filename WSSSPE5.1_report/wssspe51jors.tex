...
%. The WSSSPE series promotes sustainable research software by positively impacting principles and best practices, careers, learning, and credit. This article discusses the Code of Conduct, idea papers, position papers, experience papers, demos, and lightning talks presented during the workshop. The main part of the article discusses the speed-blogging groups that formed during the meeting, along with the outputs of those sessions. % Finally, it discusses a survey of the workshop attendees.
...
%
%These workshops dedicated a significant portion of their time to 
included 
...
%Submissions to WSSSPE5.1 were made to two tracks, either as lightning talks (up to two pages) or papers (up to four pages). Track 1 -- ``The state of the art in sustainable research software'' - called for submissions that report and evaluate past and ongoing projects; Track 2 -- ``Towards a sustainable future for research software'' - called for submissions that identify new proposals for making research software sustainable.
...
%and discussion about attendee opinions of the meeting (\S\ref{sec:survey}),
...
Submissions to WSSSPE5.1 comprised six papers %(four in Track 1; two in Track 2) 
and eight lightning talks. %(six in Track 1; two in  Track 2).
Of these, four papers \cite{nangia_track_2017,haupt_track_2017,queiroz_track_2017,mulholland_track_2017} %(three in Track 1; one in Track 2) 
and seven lightning talks \cite{silva_track_2017,struck_track_2017,washbrook_track_2017,dasler_track_2017,alhozaimy_track_2017,maassen_track_2017,druskat_track_2017} %(five in Track 1; two in Track 2)
were accepted.
...
%WSSSPE5.1 included the presentation of four 12-minute talks based on accepted papers \cite{nangia_track_2017,haupt_track_2017,queiroz_track_2017,mulholland_track_2017}, and seven 6-minute lightning talks \cite{silva_track_2017,struck_track_2017,washbrook_track_2017,dasler_track_2017,alhozaimy_track_2017,maassen_track_2017,druskat_track_2017}.
...
%They provide helpful approaches and pointers to some valuable resources on academic writing.
%
...
%
Based on the presentations and working groups at WSSSPE5.1, we have presented a set of topics and mapped the %WSSSPE5.1
